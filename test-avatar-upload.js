...
async function testAvatarUpload() {
  ...
  try {
    ...
    if (uploadError) {
      ...
      console.log("✅ URL format correct for frontend:", urlData.publicUrl.startsWith('https://'));
      
      // Test if URL is accessible (basic validation)
      const isValidUrl = urlData.publicUrl && urlData.publicUrl.includes('supabase.co');
